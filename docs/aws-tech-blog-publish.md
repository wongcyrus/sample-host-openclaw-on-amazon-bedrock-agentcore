...
`[MARKER - UPLOAD COVER IMAGE: system_design/img/blog_cover.png]`
...
`[MARKER - INSERT DIAGRAM: OpenClaw High-Level System Architecture / system_design/img/overall_architecture_topology_aws.png]`
...
`[MARKER - INSERT DIAGRAM: Double-Sided Dashboard Telemetry Relay / system_design/img/aws_blog_dashboard_relay_aws.png]`
...
`[MARKER - INSERT DIAGRAM: Omnichannel Webhook Routing & Session Lookup Sequence / system_design/img/router_webhook_flow_aws.png]`
